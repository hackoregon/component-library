...
var _StoryLink = require('../StoryCard/StoryLink');
...
var ShareCollection = function (_Component) {
  _inherits(ShareCollection, _Component);

  function ShareCollection(props) {
    _classCallCheck(this, ShareCollection);

    var _this = _possibleConstructorReturn(this, (ShareCollection.__proto__ || Object.getPrototypeOf(ShareCollection)).call(this, props));
  ...
  _createClass(ShareCollection, [{
    ...
    value: function render() {
      var shareTxt = this.state.copied ? 'Link copied!' : 'Share'; // if copied, show Link copied, otherwise, show Share card
